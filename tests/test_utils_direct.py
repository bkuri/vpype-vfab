...
mock_vpype.write_svg = MagicMock()
mock_vpype.__version__ = "1.15.0"
mock_document_class = MagicMock()
sys.modules["vpype"] = mock_vpype
sys.modules["vpype.Document"] = mock_document_class

# Mock click with proper behavior
...
spec = importlib.util.spec_from_file_location(
    "src.utils", "/home/bk/source/vpype-plotty/src/utils.py"
)
...
mock_exceptions.PlottyJobError = PlottyJobError
...
save_document_for_plotty = utils_module.save_document_for_plotty
...
class TestSaveDocumentForPlotty:
    ...
    def test_save_document_success(self, temp_dir, mock_document):
        ...
        mock_vpype.write_svg.assert_called_once()
...
class TestValidatePreset:
    ...
    def test_validate_preset_invalid(self):
        ...
        with pytest.raises(BadParameter, match="Invalid preset"):
...
class TestFormatJobStatus:
    ...
    def test_format_status_simple_missing_state(self):
        ...
        # This should raise KeyError since simple format doesn't handle missing state
        with pytest.raises(KeyError):
            format_job_status(job_data, "simple")
...
class TestFormatJobList:
    ...
    def test_format_list_empty_json(self):
        ...
        # The function returns "No jobs found." for all empty formats
        assert result == "No jobs found."
